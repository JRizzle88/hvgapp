...
@section('content')
		...
		<div class="col-sm-8 col-md-8 col-lg-8">
          ...
          <h2>All Articles {!! link_to_route('admin.posts.create', 'New Article', '', array('class'=>'btn btn-success btn-sm')) !!}</h2>
							...
							<tbody>
								@foreach( $posts as $p )
									<tr>
										...
										<td>{{ $p->created_at }}</td>
										<td>
											{!! Form::open(array('class' => 'form-inline', 'method' => 'DELETE', 'route' => array('admin.posts.destroy', $p->slug))) !!}
												{!! link_to_route('posts.show', '', $p->slug, array('class' => 'fa fa-eye text-success fa-2x')) !!}
												{!! link_to_route('admin.posts.edit', '', $p->slug, array('class' => 'fa fa-edit fa-2x')) !!}
