	...
	<div class="col-sm-8 col-md-8 col-lg-8 backend-article">
		<div class="panel panel-default">
			<div class="panel-body">
	          <h2>Edit Article <span><a href="{{ url('author/posts') }}" class="btn btn-primary btn-sm">Back to Articles</a></span></h2>
	          {!! Form::model($post, ['method' => 'PATCH', 'route' => ['author.posts.update', $post->slug], 'files' => true]) !!}
	            @include('author/posts/partials/_form', ['submit_text' => 'Save Article'])
	          {!! Form::close() !!}
			@if($post->draft == 1)
