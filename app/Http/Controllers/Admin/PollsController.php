...
class PollsController extends Controller {
	...
	public function store(Request $request)
	{
		...
		return Redirect::route('admin.polls.index')->with('message', 'Poll created');
	}
	...
	public function update(Poll $poll, Request $request)
	{
		...
		return Redirect::route('admin.polls.index')->with('message', 'Poll updated.');
	...
	public function destroy(Poll $poll)
	{
		...
		return Redirect::route('admin.polls.index')->with('message', 'Poll deleted.');
